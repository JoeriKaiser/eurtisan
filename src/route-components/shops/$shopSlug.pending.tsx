  ...
  return (
    <main className='page-wrap px-4 pb-16 pt-14'>
      <div className='island-shell rounded-2xl px-6 py-10 sm:px-10 sm:py-14'>
        <div className='mb-4 size-4 animate-pulse rounded bg-surface-inset' />
        <div className='mb-4 h-10 w-1/3 animate-pulse rounded bg-surface-inset' />
        <div className='h-4 w-1/2 animate-pulse rounded bg-surface-inset' />
      </div>
      <div className='mt-8'>
