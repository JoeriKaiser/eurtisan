...
function MollieMockOauth() {
  const { shopId, redirect_uri } = Route.useSearch()
  ...
  return (
    <div className='flex min-h-screen items-center justify-center bg-slate-900 px-4 py-12 text-slate-100 font-sans'>
      ...
      <div className='pointer-events-none absolute inset-0 overflow-hidden'>
        <div className='absolute -left-40 -top-40 h-96 w-96 rounded-full bg-blue-600/10 blur-[100px]' />
        <div className='absolute -bottom-40 -right-40 h-96 w-96 rounded-full bg-indigo-600/10 blur-[100px]' />
      </div>
      ...
      <div className='relative w-full max-w-md overflow-hidden rounded-2xl border border-slate-800 bg-slate-950 p-6 shadow-2xl sm:p-8'>
        ...
        <div className='mb-8 flex items-center justify-between border-b border-slate-800 pb-5'>
          <div className='flex items-center gap-2.5'>
            ...
            <div className='flex h-8 w-8 items-center justify-center rounded-lg bg-blue-600 font-black text-white tracking-tighter text-sm'>
              M
            </div>
        ...
        <div className='text-center mb-6'>
          <div className='mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-blue-950/80 border border-blue-800/40 text-blue-400'>
            <ShieldCheck size={28} />
          </div>
          <h2 className='text-lg font-bold text-white mb-2'>Authorize Eurtisan</h2>
