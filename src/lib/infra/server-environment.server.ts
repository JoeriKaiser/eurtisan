...
const serverEnvironmentSchema = z
  .object({
    ...
    OPERATOR_LEGAL_NAME: requiredString.default('Eurtisan Platform'),
    OPERATOR_LEGAL_EMAIL: z.string().email().default('legal@eurtisan.eu'),
    OPERATOR_BILLING_EMAIL: z.string().email().default('billing@eurtisan.eu'),
    OPERATOR_VAT_ID: requiredString.default('FR00000000000'),
    OPERATOR_STREET: requiredString.default('1 Place de la République'),
