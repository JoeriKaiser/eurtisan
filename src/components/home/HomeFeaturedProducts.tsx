  ...
  return (
    <section aria-labelledby='products-heading' className='py-8 animate-fade-in-up'>
      ...
      {products.length === 0 ? (
        ...
        <div className='flex snap-x snap-mandatory gap-4 overflow-x-auto pb-4 sm:grid sm:grid-cols-2 sm:gap-6 sm:overflow-visible sm:pb-0 lg:grid-cols-4'>
          {products.map((product) => (
            <div key={product.id} className='grid min-w-[82vw] snap-start sm:min-w-0'>
