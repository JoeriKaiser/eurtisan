...
vi.mock('#/paraglide/messages', () => ({
  m: {
    ...
    shipping_origin_title: () => 'Shipping Origin Address',
    shipping_origin_description: () => 'Used to generate shipping labels for your orders.',
    shipping_origin_city_placeholder: () => 'Berlin',
    ...
    shop_settings_tax_settings_title: () => 'Tax settings',
    shop_settings_vat_registered_label: () => 'I am VAT registered',
    shop_settings_vat_registered_description: () => 'Toggle if your shop is VAT registered.',
    shop_settings_vat_id_label: () => 'VAT ID',
    shop_settings_vat_id_placeholder: () => 'e.g., FR12345678901',
    shop_settings_tax_identity_title: () => 'Tax identity',
    shop_settings_tax_identity_description: () => 'Tax identity details used for invoicing.',
    shop_settings_legal_entity_type_label: () => 'Legal entity type',
    shop_settings_legal_entity_individual: () => 'Individual',
    shop_settings_legal_entity_business: () => 'Business',
    shop_settings_tax_id_label: () => 'Tax ID',
    shop_settings_tax_id_placeholder: () => 'e.g., 123456789',
