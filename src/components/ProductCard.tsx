    ...
    >
      ...
      <div className='flex flex-1 flex-col p-4'>
        ...
        <div className='mt-auto flex items-end justify-between gap-2'>
          <span className='text-base font-bold text-[var(--sea-ink)]'>{formatPriceEUR(product.priceCents)}</span>
          ...
          <span className='inline-flex items-center gap-1 rounded-full bg-[var(--chip-bg)] px-2 py-1 text-xs text-[var(--sea-ink-soft)] border border-[var(--chip-line)]'>
            ...
            <span className='max-w-[120px] truncate'>{product.shopName ?? m.product_unknown_shop()}</span>
          </span>
        </div>
      </div>
    </article>
