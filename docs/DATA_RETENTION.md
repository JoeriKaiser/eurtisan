...
| DB backups | Logical: 30 days local, 90 days off-site; physical/WAL: 4 full and 14 differential pgBackRest generations | `infrastructure/README.md`; provider lifecycle owns off-site logical/upload expiration |
